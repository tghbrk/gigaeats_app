...
class CustomerRepository extends BaseRepository {
  ...
  Stream<List<Customer>> getCustomersStream({
    ...
    return executeStreamQuery(() async* {
      ...
      dynamic streamBuilder = supabase
          .from('customers')
  ...
  Future<Map<String, dynamic>> getCustomerStatistics() async {
    return executeQuery(() async {
      ...
      final response = await supabase.rpc('get_customer_statistics', params: {
  ...
  Future<void> updateCustomerOrderStats(
    ...
    return executeQuery(() async {
      await supabase.rpc('update_customer_order_stats', params: {
  ...
  Future<String?> _getCurrentSalesAgentId() async {
    ...
    try {
      ...
      debugPrint('CustomerRepository: Looking for sales agent with Supabase UID: $currentUserId');
      ...
      debugPrint('CustomerRepository: No user found with Firebase UID: $currentUserId');
      return null;
    } catch (e) {
