...
class _CustomerPaymentMethodsScreenState
  ...
  void _editPaymentMethod(CustomerPaymentMethod paymentMethod) {
    showDialog(
      context: context,
  ...
  void _deletePaymentMethod(CustomerPaymentMethod paymentMethod) {
    showDialog(
      context: context,
  ...
  void _setDefaultPaymentMethod(CustomerPaymentMethod paymentMethod) async {
