...
import '../providers/customer_spending_analytics_provider.dart';
import '../providers/customer_budget_provider.dart';
import '../providers/wallet_analytics_provider.dart';
import '../widgets/spending_analytics_widgets.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Recent trends chart
          const SpendingTrendsChart(height: 200),
        ],
      ),
    );
  }
