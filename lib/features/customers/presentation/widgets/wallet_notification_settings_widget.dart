...
class _WalletNotificationSettingsWidgetState extends ConsumerState<WalletNotificationSettingsWidget> {
  final Map<WalletNotificationType, Map<NotificationChannel, bool>> _preferences = {};
  ...
  Future<void> _loadNotificationPreferences() async {
    ...
    try {
      ...
      for (final type in WalletNotificationType.values) {
        _preferences[type] = {};
  ...
  bool _getDefaultPreference(WalletNotificationType type, NotificationChannel channel) {
    // Default preferences based on notification type and channel
    switch (type) {
      case WalletNotificationType.transactionReceived:
      case WalletNotificationType.transactionSent:
      case WalletNotificationType.lowBalance:
      case WalletNotificationType.spendingLimitReached:
      case WalletNotificationType.securityAlert:
        return channel == NotificationChannel.push;
      case WalletNotificationType.autoReloadTriggered:
        return channel == NotificationChannel.push;
      case WalletNotificationType.weeklySummary:
        return false;
      case WalletNotificationType.monthlySummary:
    ...
    return Column(
      ...
      children: [
        ...
        _buildNotificationSection(
          ...
          [
            WalletNotificationType.transactionReceived,
            WalletNotificationType.transactionSent,
          ],
        ),
        const SizedBox(height: 16),
        ...
        _buildNotificationSection(
          ...
          [
            WalletNotificationType.lowBalance,
            WalletNotificationType.spendingLimitReached,
            WalletNotificationType.autoReloadTriggered,
          ],
        ),
        const SizedBox(height: 16),
        ...
        _buildNotificationSection(
          ...
          [
            WalletNotificationType.securityAlert,
          ],
        ),
        const SizedBox(height: 16),
        ...
        _buildNotificationSection(
          ...
          [
            WalletNotificationType.weeklySummary,
            WalletNotificationType.monthlySummary,
          ],
        ),
  ...
  Widget _buildNotificationSection(
    ...
    String title,
    String description,
    List<WalletNotificationType> types,
  ) {
    final theme = Theme.of(context);
  ...
  Widget _buildNotificationTypeRow(BuildContext context, WalletNotificationType type) {
    final theme = Theme.of(context);
  ...
  void _toggleNotificationPreference(WalletNotificationType type, NotificationChannel channel) {
    setState(() {
