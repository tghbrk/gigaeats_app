...
class DriverLocationTrackingWidget extends ConsumerWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            locationPermissions.when(
              data: (hasPermissions) => _buildPermissionsStatus(hasPermissions, theme),
            ...
            currentLocation.when(
              data: (location) => _buildLocationStatus(location, theme),
              loading: () => const Row(
                children: [
                  SizedBox(
                    width: 16,
  ...
  Widget _buildTrackingButton(
    ...
    WidgetRef ref,
    bool isTracking,
    DriverLocationActions locationActions,
  ) {
