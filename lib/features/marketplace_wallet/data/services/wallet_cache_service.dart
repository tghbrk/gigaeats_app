  ...
  Future<CacheStatistics> getCacheStatistics() async {
    try {
      ...
      for (final key in keys) {
        if (key.startsWith(_walletPrefix)) walletCount++;
        else if (key.startsWith(_transactionsPrefix)) transactionsCount++;
        else if (key.startsWith(_payoutsPrefix)) payoutsCount++;
        else if (key.startsWith(_analyticsPrefix)) analyticsCount++;
      }
