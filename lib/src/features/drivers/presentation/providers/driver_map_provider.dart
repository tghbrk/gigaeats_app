...
import 'driver_proximity_provider.dart';
...
class DriverMapNotifier extends StateNotifier<DriverMapState> {
  ...
  Future<void> _loadActiveOrder() async {
    try {
      ...
      activeOrders.whenData((orders) async {
      ...
      markers.add(
        Marker(
          ...
          infoWindow: InfoWindow(
            ...
            snippet: state.activeOrder?.vendorName ?? '',
          ),
        ),
      );
    }
      ...
      markers.add(
        Marker(
          ...
          infoWindow: InfoWindow(
            ...
            snippet: state.activeOrder?.deliveryAddress.fullAddress ?? '',
          ),
        ),
      );
    }
