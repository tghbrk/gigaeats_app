                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            // TODO: Fix DriverStatus type conflict
                            Container(
                              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                              decoration: BoxDecoration(
                                color: driver.status == DriverStatus.online ? Colors.green : Colors.grey,
                        ...
                        Row(
                          children: [
                            Icon(
                              _getVehicleIcon(driver.vehicleType.name),
                              size: 16,
                              color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6),
                            ),
                            const SizedBox(width: 4),
                            Text(
                              '${driver.vehicleModel ?? 'Unknown'} (${driver.vehiclePlateNumber ?? 'No Plate'})',
                              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6),
                              ),
                            ),
  ...
  List<Driver> _getFilteredDrivers() {
    ...
    return _availableDrivers.where((driver) {
      return driver.name.toLowerCase().contains(_searchQuery.toLowerCase()) ||
             ...
             (driver.vehiclePlateNumber?.toLowerCase().contains(_searchQuery.toLowerCase()) ?? false);
    }).toList();
  }
