...
class _VendorDetailsTestScreenState extends ConsumerState<VendorDetailsTestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const Center(child: Text('Vendor details test coming soon')),
      // TODO: Fix vendorsState provider and rebuild UI
      /*
  ...
  // TODO: Remove unused method - commented out due to provider issues
  /*
