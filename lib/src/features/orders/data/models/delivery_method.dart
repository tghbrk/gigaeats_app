enum DeliveryMethod {
  ...
  thirdParty('third_party', 'Third Party Delivery');
  ...
  bool get isThirdParty => this == DeliveryMethod.thirdParty;
  bool get requiresDriver => isOwnFleet || isThirdParty;
  bool get isPickup => isCustomerPickup || isSalesAgentPickup;
  bool get requiresAddress => isSalesAgentPickup || isOwnFleet || isThirdParty;
  bool get hasDeliveryFee => isOwnFleet || isThirdParty;
}
