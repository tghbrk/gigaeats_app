...
import 'customer/customer_cart_provider.dart'; // Import customer cart provider
...
class OrdersNotifier extends StateNotifier<OrdersState> {
  ...
  Future<Order?> createOrder({
    ...
    try {
      ...
      // Use customer cart provider for customer orders
      ...
      if (customerId == null) {
        ...
        try {
          ...
          if (existingCustomer == null) {
            ...
            // TODO: Fix Customer model constructor mismatch - new Customer model has different signature
            // Create a new customer using correct constructor parameters
            // final newCustomer = Customer(...);
            // await customerRepo.createCustomer(newCustomer);

            // Temporary fix for type assignment issue
            DebugLogger.warning('Customer creation temporarily disabled due to model mismatch', tag: 'OrderProvider');
