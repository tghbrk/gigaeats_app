...
import '../../../../drivers/presentation/providers/driver_earnings_provider.dart';
import '../../../../drivers/presentation/widgets/earnings_charts_widget.dart';
import '../../../../drivers/presentation/widgets/driver_performance_dashboard.dart';
import '../../../../drivers/presentation/widgets/earnings_notifications_widget.dart';
import '../../../../drivers/presentation/widgets/earnings_overview_cards.dart';
      ...
      builder: (context, ref, child) {
        ...
        return driverIdAsync.when(
          ...
          data: (driverId) {
            ...
            return DriverPerformanceDashboard(driverId: driverId);
          },
        );
      },
    );
