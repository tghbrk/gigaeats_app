...
// TODO: Fix Customer model mismatch - provider uses old Customer model but repository returns new Customer model
import '../../../../presentation/providers/repository_providers.dart';
import '../../data/repositories/customer_repository.dart' as user_mgmt;

/// User Management Customer Repository Provider
final userMgmtCustomerRepositoryProvider = Provider<user_mgmt.CustomerRepository>((ref) {
  return user_mgmt.CustomerRepository();
});
...
class CustomerNotifier extends StateNotifier<CustomerState> {
  final user_mgmt.CustomerRepository _repository;
  final Ref _ref;
...
final customerProvider = StateNotifierProvider<CustomerNotifier, CustomerState>((ref) {
  final repository = ref.watch(userMgmtCustomerRepositoryProvider);
...
final webCustomersProvider = FutureProvider.family<List<Customer>, Map<String, dynamic>>((ref, params) async {
  ...
  // TODO: Restore when repository method signature matches
  ...
  //   // TODO: Restore when CustomerType is implemented
  ...
  // );
  final result = <Customer>[]; // Placeholder until method signature is fixed
...
final simpleWebCustomersProvider = FutureProvider<List<Customer>>((ref) async {
  ...
  return <Customer>[]; // Placeholder until method signature is fixed
});
...
final searchCustomersProvider = FutureProvider.family<List<Customer>, String>((ref, query) async {
  // TODO: Restore when repository method signature matches
  // final repository = ref.watch(customerRepositoryProvider);
  // return repository.searchCustomers(query, limit: 20);
  return <Customer>[]; // Placeholder until method signature is fixed
});
