...
// Local Sales Agent Service Provider for user_management module
final userManagementSalesAgentServiceProvider = Provider<SalesAgentService>((ref) {
...
final salesAgentNotificationSettingsProvider = StateNotifierProvider.family<
  ...
  final salesAgentService = ref.watch(userManagementSalesAgentServiceProvider);
