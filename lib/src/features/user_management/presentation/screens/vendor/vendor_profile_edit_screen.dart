...
// TODO: Restore when vendor_profile_form_screen is used
...
class _VendorProfileEditScreenState extends ConsumerState<VendorProfileEditScreen> {
  ...
  Widget build(BuildContext context) {
    // TODO: Restore when currentVendorProfileProvider is implemented
    // final currentVendorAsync = ref.watch(currentVendorProfileProvider);

    // TODO: Restore when currentVendorAsync.when is implemented
    return Scaffold(
      appBar: AppBar(title: const Text('Edit Vendor Profile')),
      body: const Center(child: Text('Vendor profile editing not available')),
    );
