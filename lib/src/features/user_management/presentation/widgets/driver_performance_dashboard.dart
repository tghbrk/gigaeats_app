...
class DriverPerformanceDashboard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final performanceSummary = AsyncValue.data(<String, dynamic>{});
    final goalsAndAchievements = AsyncValue.data(<String, dynamic>{});
        ...
        children: [
          ...
          performanceSummary.when(
            ...
            error: (error, stack) => CustomErrorWidget(
              ...
              onRetry: () => debugPrint('Retry not implemented'),
            ),
          ),
